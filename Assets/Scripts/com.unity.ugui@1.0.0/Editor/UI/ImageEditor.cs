...
namespace UnityEditor.UI
{
    ...
    public class ImageEditor : GraphicEditor
    {
        ...
        SerializedProperty m_WindowsShadesNumber;
        ...
        protected override void OnEnable()
        {
            ...
            m_WindowsShadesNumber = serializedObject.FindProperty("m_WindowsShadesNumber");
            ...
            m_ShowWindowsShades = new AnimBool(!m_Type.hasMultipleDifferentValues && typeEnum == Image.Type.WindowsShades);
            m_ShowSlicedOrTiled.valueChanged.AddListener(Repaint);
            m_ShowSliced.valueChanged.AddListener(Repaint);
            m_ShowTiled.valueChanged.AddListener(Repaint);
            m_ShowFilled.valueChanged.AddListener(Repaint);
            m_ShowWindowsShades.valueChanged.AddListener(Repaint);
        ...
        protected void TypeGUI()
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                m_ShowWindowsShades.target = (!m_Type.hasMultipleDifferentValues && typeEnum == Image.Type.WindowsShades);
                ...
                if (EditorGUILayout.BeginFadeGroup(m_ShowWindowsShades.faded))
                {
                    EditorGUI.BeginChangeCheck();
                    EditorGUILayout.PropertyField(m_WindowsShadesNumber);
                    EditorGUILayout.PropertyField(m_FillAmount);
                }
                EditorGUILayout.EndFadeGroup();
            }
